...
import { FIELD_REQUIRED_MESSAGE, singleFileValidator } from '../../utils/validators.js'
...
import { selectCurrentUser, updateUserAPI } from '../../components/redux/user/userSlice.js'
...
function AccountTab() {
  ...
  useEffect(() => {
    // Kiểm tra nếu không có user trong Redux, thì redirect về trang login
    if (!currentUser) {
      toast.error('User deleted or not found. Please login again.');
...
// import { useForm } from 'react-hook-form'
// import { toast } from 'react-toastify'
// import VisuallyHiddenInput from '../../components/Form/VisuallyHiddenInput.jsx'
...
//           <Box>
//             <Typography variant="h6">{currentUser?.displayName}</Typography>
//             <Typography sx={{ color: 'grey' }}>@{currentUser?.displayName}</Typography>
//           </Box>
//         </Box>
